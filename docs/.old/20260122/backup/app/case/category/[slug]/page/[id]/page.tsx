...
import { getCaseAll, getCaseAllByCategory, getCaseCategory } from '@/lib/api'
...
export default async function Post({ params }: Params) {
  ...
  //カテゴリー絞り込み一覧の取得
  const id = params.id
  const postsObj = await getCaseAllByCategory(cat.id, id, PER_PAGE)
